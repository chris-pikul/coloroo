...
var _ColorRGB_rgb, _ColorRGB_alpha;
...
class ColorRGB {
     ...
     * ```
     */
    constructor(_arg1, _argG, _argB, _argA) {
        /**
         * Holds the RGB components as an tuple array
         */
        _ColorRGB_rgb.set(this, [
            0,
            0,
            0,
        ]);
         ...
         */
        this.redUnit = () => (this.red / 255);
        /**
         * Gets the green component as a unit
         *
         * @returns Unit value (0..1)
         */
        this.greenUnit = () => (this.green / 255);
        /**
         * Gets the blue component as a unit
         *
         * @returns Unit value (0..1)
         */
        this.blueUnit = () => (this.blue / 255);
        // Bind methods
     ...
     */
    get red() {
        return __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[0];
    }
    set red(byteValue) {
        __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[0] = (0, math_1.clampByte)(byteValue);
    }
    /**
     * The green component as a byte (0..255) integer
     */
    get green() {
        return __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[1];
    }
    set green(byteValue) {
        __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[1] = (0, math_1.clampByte)(byteValue);
    }
    /**
     * The blue component as a byte (0..255) integer
     */
    get blue() {
        return __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[2];
    }
    set blue(byteValue) {
        __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[2] = (0, math_1.clampByte)(byteValue);
    }
    /**
     ...
     */
    toArray() {
        return [...__classPrivateFieldGet(this, _ColorRGB_rgb, "f"), __classPrivateFieldGet(this, _ColorRGB_alpha, "f")];
    }
    /**
    ...
    toUnitArray() {
        return [
            ...
            this.greenUnit(),
            this.blueUnit(),
            __classPrivateFieldGet(this, _ColorRGB_alpha, "f"),
        ];
    }
    /**
        ...
        for (let ind = 0; ind < components.length; ind++) {
            ...
            if (ind <= 2) {
                ...
                if (type === params_1.ParameterType.INTEGER)
                    __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[ind] = (0, math_1.clamp)(value, 0, 255);
                else if (type === params_1.ParameterType.FLOAT)
                    __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[ind] = (0, math_1.clampByte)(value);
                else if (type === params_1.ParameterType.PERCENTAGE)
                    __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[ind] = (0, math_1.clampByte)(value * 255);
                else
                    __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[ind] = 0;
            }
            else if (ind === 3) {
    ...
    setUnits(...components) {
        for (let ind = 0; ind < components.length; ind++) {
            if (ind <= 2)
                __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[ind] = Math.trunc((0, math_1.clamp)(components[ind]) * 255);
            else if (ind === 3)
                __classPrivateFieldSet(this, _ColorRGB_alpha, (0, math_1.clamp)(components[ind]), "f");
            else
                break;
        }
        return this;
     ...
     */
    setRedUnit(unit) {
        this.red = (0, math_1.clamp)(unit) * 255;
        return this;
    }
    /**
     ...
     */
    setGreenUnit(unit) {
        this.green = (0, math_1.clamp)(unit) * 255;
        return this;
    }
    /**
     * Sets the green component of this RGB color with a byte value (0..255)
     ...
     */
    setBlueUnit(unit) {
        this.blue = (0, math_1.clamp)(unit) * 255;
        return this;
    }
    /**
    ...
    fromInteger(value, useAlpha = false, alphaMSB = false) {
        ...
        // Red component
        __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[0] = (int >> 16) & 0xFF;
        // Green component
        __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[1] = (int >> 8) & 0xFF;
        // Blue component
        __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[2] = int & 0xFF;
        return this;
    }
    /**
    ...
    fromHexString(str) {
        ...
        if (hexMatch && hexMatch.length === 2) {
            ...
            if (hex.length === 3) {
                ...
                __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[2] = htf(int & 0xF);
                __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[1] = htf((int & 0xF0) >>> 4);
                __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[0] = htf((int & 0xF00) >>> 8);
            }
            else if (hex.length === 4) {
                // 4 length hex implies shorthand 4-bit colors (RGBA)
                __classPrivateFieldSet(this, _ColorRGB_alpha, htf(int & 0xF) / 255.0, "f");
                __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[2] = htf((int & 0xF0) >>> 4);
                __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[1] = htf((int & 0xF00) >>> 8);
                __classPrivateFieldGet(this, _ColorRGB_rgb, "f")[0] = htf((int & 0xF000) >>> 12);
            }
    ...
    fromString(str) {
        ...
        if (clnStr === 'transparent') {
            __classPrivateFieldSet(this, _ColorRGB_rgb, [
                0,
                0,
                0,
            ], "f");
    ...
    luminosity() {
        ...
        const lum = __classPrivateFieldGet(this, _ColorRGB_rgb, "f").map(chan => {
     ...
     */
    invert(alpha = false) {
        return new ColorRGB(255 - this.red, 255 - this.green, 255 - this.blue, alpha ? (1 - __classPrivateFieldGet(this, _ColorRGB_alpha, "f")) : __classPrivateFieldGet(this, _ColorRGB_alpha, "f"));
    }
    /**
     * __Immutable__
     *
    ...
    desaturate() {
        ...
        return new ColorRGB().setUnits(gray, gray, gray);
    }
    /**
     * __Immutable__
     *
    ...
    lerp(other, delta) {
        ...
        const arr = this.toArray().map((val, ind) => (0, math_1.lerp)(val, otherArr[ind], delta));
        return new ColorRGB(arr);
    }
}
exports.ColorRGB = ColorRGB;
_ColorRGB_rgb = new WeakMap(), _ColorRGB_alpha = new WeakMap();
/**
